...
// 사용자의 URL 요청을 처리하겠다.
//@RestController
// RestController는 return이 무조건 json
// 그 값 자체가 json
// RestController를 붙이면 html에 연결이 어려움
@Controller
...
public class BoardController {
    ...
    public ResponseEntity<byte[]> fileServe() throws Exception {
        ...
        try {
            ...
            // Media.Application Octet Stream은 보통 파일을 다운받거나 할 때 사용한다.
    ...
    public String registerPostForm(String userId, String passwd, Date date) {
        ...
        log.info("userId = " + userId + "passwd = " + passwd + " date = "+date);
        return "success";
    }
